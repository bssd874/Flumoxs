import 'package:flumoxs/screens/home/another_screen/TA/widgetsTA/sample_product_TA.dart';
import 'package:flutter/material.dart';
import 'package:url_launcher/url_launcher.dart';

class DetailScreenTA extends StatefulWidget {
  const DetailScreenTA({super.key});

  @override
  State<DetailScreenTA> createState() => _DetailScreenTAState();
}

class _DetailScreenTAState extends State<DetailScreenTA> {
        ...
        child: Column(
          ...
          children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    child: ClipRRect(
                      ...
                      child: Image.asset(
                        "assets/images/503107ec-64a4-47f2-9d5e-f30cfbbf7c9e.jpg",
                        width: 100,
                        height: 100,
                        fit: BoxFit.cover,
                      ),
            ...
            Padding(
              ...
              child: Text(
                "Menyediakan jasa foto atau video makanan siap saji bertujuan untuk membantu orang-orang yang ingin memperjual belikan produk makanan mereka.",
                style: TextStyle(
                  fontFamily: 'Roboto',
                  fontWeight: FontWeight.w300,
                  fontSize: 13,
