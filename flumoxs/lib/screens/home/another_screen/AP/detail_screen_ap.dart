import 'package:flumoxs/screens/home/another_screen/AP/widgetsAP/sample_product_AP.dart';
import 'package:flutter/material.dart';
import 'package:url_launcher/url_launcher.dart';

class DetailScreenAP extends StatefulWidget {
  const DetailScreenAP({super.key});

  @override
  State<DetailScreenAP> createState() => _DetailScreenAPState();
}

class _DetailScreenAPState extends State<DetailScreenAP> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Menyediakan jasa make up karakter yang unik juga menarik sesuai yang anda inginkan untuk membantu anda dalam merias tanpa susah dan ribet.",
                style: TextStyle(
                  fontFamily: 'Roboto',
                  fontWeight: FontWeight.w300,
                  fontSize: 13,
