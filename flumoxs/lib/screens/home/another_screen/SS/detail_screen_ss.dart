import 'package:flumoxs/screens/home/another_screen/SS/widgetsSS/sample_product_SS.dart';
import 'package:flutter/material.dart';
import 'package:url_launcher/url_launcher.dart';

class DetailScreenSS extends StatefulWidget {
  const DetailScreenSS({super.key});

  @override
  State<DetailScreenSS> createState() => _DetailScreenSSState();
}

class _DetailScreenSSState extends State<DetailScreenSS> {
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Menyediakan baju dengan desain bebas sesuai dengan desain dari customer.Baju ini di buat dengan tujuan menjadi wadah para anak muda untuk berekspresi lewat gambar.",
                style: TextStyle(
                  fontFamily: 'Roboto',
                  fontWeight: FontWeight.w300,
                  fontSize: 13,
